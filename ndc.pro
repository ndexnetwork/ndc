...
DEPS_PATH=/mnt/backup/mxe/usr/i686-w64-mingw32.shared
...
macx {
    QMAKE_TARGET_BUNDLE_PREFIX = co.ndc
...
win32 {
  	BOOST_LIB_SUFFIX=-mt
	BOOST_INCLUDE_PATH=$$DEPS_PATH/include/
    BOOST_LIB_PATH=$$DEPS_PATH/lib
    OPENSSL_INCLUDE_PATH=$$DEPS_PATH/include/
    OPENSSL_LIB_PATH=$$DEPS_PATH/lib
    BDB_INCLUDE_PATH=$$DEPS_PATH/include/
    BDB_LIB_PATH=$$DEPS_PATH/lib
    MINIUPNPC_INCLUDE_PATH=$$DEPS_PATH/include/
    MINIUPNPC_LIB_PATH=$$DEPS_PATH/lib
        #USE_BUILD_INFO = 1
...
contains(NDC_NEED_QT_PLUGINS, 1) {
    DEFINES += NDC_NEED_QT_PLUGINS
...
# also add new translations to src/qt/ndc.qrc under translations/
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/ndc.rc


windows:DEFINES += WIN32
windows:RC_FILE = src/qt/res/ndc.rc
...
macx:ICON = src/qt/res/icons/ndc.icns
macx:TARGET = "NDC"
