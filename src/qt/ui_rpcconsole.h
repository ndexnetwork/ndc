...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "NDC - Debug window", Q_NULLPTR));
        label_9->setText(QApplication::translate("RPCConsole", "NDC Core", Q_NULLPTR));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the NDC debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the NDC help message to get a list with possible NDC command-line options.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        label_231->setText(QApplication::translate("RPCConsole", "Direction", Q_NULLPTR));
