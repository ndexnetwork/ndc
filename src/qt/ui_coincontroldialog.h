...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 NDC"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 NDC"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 NDC"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 NDC"));
