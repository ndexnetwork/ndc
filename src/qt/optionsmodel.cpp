...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::NDC).toInt();
    ...
    fAutoRedeemNDC = settings.value("fAutoRedeemNDC", false).toBool();
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemNDC: return "AutoRedeemNDC";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::NDC).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemNDC: {
            fAutoRedeemNDC = value.toBool();
            settings.setValue("fAutoRedeemNDC", fAutoRedeemNDC);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemNDC() { return fAutoRedeemNDC; }
