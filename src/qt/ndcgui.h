...
/**
  NDC GUI main class. This class represents the main window of the NDC UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class NDCGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit NDCGUI(QWidget *parent = 0);
    ~NDCGUI();
